...
public class ParameterFormer {
    ...
    public static void printPerformance(Performance performance) {

        System.out.println(PERFORMANCE_HEADER_LINE);
    ...
    public static Timetable randomTimetable() {
        ...
        for (int i = 0; i < countSchedules; i++) {
            ...
            timetable.getSchedules().add(new Schedule(DayHourMinute.generateRandomDateAndTime(0, SIMULATION_DURATION),
